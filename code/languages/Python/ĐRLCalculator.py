...
tieuChiHocTap = {
    ...
    "9": [
        "Tham gia các hoạt động, sự kiện liên quan đến NCKH, học thuật, chuyên môn",
        2,
    ],
...
tieuChiKyLuat = {
    "1": [
        "Tham gia 100% buổi sinh hoạt công dân/họp lớp do Trường/Viện/Lớp tổ chức",
        10,
    ],
    "2": [
        "Tham gia từ 50% buổi sinh hoạt công dân, họp lớp do Trường/Viện/Lớp tổ chức trở lên",
        5,
    ],
...
tieuChiXaHoi = {
    "1": [
        "Tham gia hoạt động văn hoá (các phòng trào văn nghệ, thi SVBK,... của Viện, Trường)",
        7,
    ],
    ...
    "6": [
        "Tham gia các diễn đàn sinh viên, các buổi toạ đàm với lãnh đạo Viện, Trường",
        3,
    ],
    "7": [
    ...
    "8": [
        "Cán bộ lớp, Đoàn - Hội hoàn thành xuất sắc nhiệm vụ được tập thể công nhận",
        6,
    ],
    ...
    "11": [
        "Cán bộ lớp, Đoàn - Hội không hoàn thành nhiệm vụ được tập thể công nhận",
        0,
    ],
}
tieuChiCongDong = {
    ...
    "2": [
        "Tham gia tuyên truyền chủ trương của Đảng, chính sách pháp luật của Nhà nước, quy định của nơi cư trú, giữ gìn an ninh – trật tự, bảo vệ sinh cảnh quan - môi trường, nếp sống văn minh nơi công cộng",
        6,
    ],
    "3": [
        "Được khen thưởng khi tham gia tuyên truyền chủ trương của Đảng, chính sách pháp luật của Nhà nước, quy định của nơi cư trú, giữ gìn an ninh – trật tự, bảo vệ sinh cảnh quan - môi trường, nếp sống văn minh nơi công cộng, hoạt động xã hội,..",
        2,
    ],
    "4": [
        "Có chứng nhận tham gia lớp bồi dưỡng nhận thức về Đảng từ mức Khá trở lên",
        2,
    ],
...
tieuChi2020 = {
    "hoctap": tieuChiHocTap,
    "kyluat": tieuChiKyLuat,
    "xahoi": tieuChiXaHoi,
    "congdong": tieuChiCongDong,
    "vipham": tieuChiViPham,
}
...
print(
    "│{:^10}│{:^80}│{:^10}│".format("STT", "Tiêu chí đánh giá điểm rèn luyện", "Điểm")
)
    ...
    for tieuchi in tieuChi2020[muc]:
        print(
            "│{:^10}│  {:<78}│{:^10}│".format(
                tieuchi,
                (
                    tieuChi2020[muc][tieuchi][0]
                    if len(tieuChi2020[muc][tieuchi][0]) <= 76
                    else tieuChi2020[muc][tieuchi][0][:76]
                ),
                tieuChi2020[muc][tieuchi][1],
            )
        )
